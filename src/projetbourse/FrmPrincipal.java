...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    int numTrader;
    int numAction;
    private Object tblActions;
    private Object tblTraders;
    private Object prixTotalAction;
    private Object quantiteAcheter;
    public FrmPrincipal() {
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        Action act2 = new Action(1, "Apple", 171.89, 173, 54);
        Action act3 = new Action(1, "Facebook", 105.67, 98.45, 145);
        Action act4 = new Action(1, "Microsoft", 110,113.108, 32);
        Action act5 = new Action(1, "Dell", 56.12, 54, 78);
        Action act6 = new Action(1, "VMWare", 121.56, 123.91, 43);
        Action act7 = new Action(1, "IBM", 42.61, 40.98, 126);
        ...
        for(Trader trad : mesTraders)
        {
            for(Action act : trad.getLesActions(lesActions))
            {
                if(trad.getLesActions()!=Integer.parseInt(tblActions.getValueAt(tblActions.getSelectedRow(),0).toString())
                        {
                            
                    prixTotalAction = act.getPrixAchatAction()+prixTotalAction
                    quantiteAcheter = act.getQuantiteAchatAction()+quantiteAcheter
 ...
 dtmActions. removeRow (0);
        ...
        for(Trader trad : mesTraders)
        {
            if(Integer. parseInt (tblTraders.getValueAt(tblTraders.getSelectedRow(),0).toString()) == trad.getIdTrader())
            {
 ...
 valeurReel=valeurReel+act.getValeurActionA();
 valeurAcheter = valeurAcheter + act.getValeurActionB();
 qntAcheter = qntAcheter + act.getQuantiteAction();
                }
            }
        }
